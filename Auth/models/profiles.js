...
module.exports = function(sequelize, DataTypes) {
    ...
    profiles.associate=function (models) {
        ...
        profiles.belongsToMany(models.orgs, {foreignKeyConstraint: true, as: 'orgs', through: 'profiles_orgs', foreignKey: 'profile_id',otherKey: 'org_id' })
        ...
        profiles.hasMany(models.permissions,{foreignKeyConstraint: true})
